...
public class Entity {
  ...
  //Entity(tag, scale, hasRender, hasInput, hasShooter, hasHealth, hasComms, hasRb, isAI)
  ...
  public void update() {
    ...
    if (hasAI) {
      ...
      //Vector2D playerLoc = commsChannel.getPacket(0).getLocation();
      Vector2D test = new Vector2D(0,0);
      ai.update(test, transform);
