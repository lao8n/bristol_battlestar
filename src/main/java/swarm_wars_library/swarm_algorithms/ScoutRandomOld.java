...
// public class ScoutRandomOld extends AbstractSwarmAlgorithm {
...
//   public ScoutRandom(ENTITY tag, int id, Transform transform, RigidBody rb){
//     super(tag, transform);
//     this.id = id;
//     this.rb = rb;
...
//     Vector2D separate_v2d = this.separate_rule.iterateOverSwarm(this.tag, 20.0);
