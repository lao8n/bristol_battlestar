...
public class SpecialGhostSwarmRules extends AbstractSwarmRules {
  ...
  //=========================================================================//
  public SpecialGhostSwarmRules(int ruleId, RigidBody ruleRb,
                                Transform ruleTransform){
    super(ruleId, ruleRb, ruleTransform);
  }

  //=========================================================================//
  // Defend Shell Swarm Rules                                                //
  //=========================================================================//
  @Override 
  ...
  //=========================================================================//
  // Defend Shell Neighbourhood Count Rules                                  //
  //=========================================================================//
  @Override 
